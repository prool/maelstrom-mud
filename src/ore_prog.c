...
bool tprog_wordlist_check( char * arg, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, int type, TRAP_DATA * tprogs );
bool tprog_spell_check( int sn, CHAR_DATA * actor, OBJ_DATA * obj, void * vo, int type, TRAP_DATA * tprogs );
bool tprog_percent_check( CHAR_DATA * actor, OBJ_DATA * obj, void * vo, int type, TRAP_DATA * tprogs );
...
void eprog_lock_trigger( EXIT_DATA * pExit, ROOM_INDEX_DATA * room, CHAR_DATA * ch, OBJ_DATA * key ) {
...
void eprog_unlock_trigger( EXIT_DATA * pExit, ROOM_INDEX_DATA * room, CHAR_DATA * ch, OBJ_DATA * key ) {
