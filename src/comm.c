...
bool check_ban( struct descriptor_data * dnew, bool loggedin );
bool check_newban( struct descriptor_data * dnew, bool loggedin );
...
void auth_maxdesc( int * maxdesc, fd_set * in_set, fd_set * out_set, fd_set * exc_set );
