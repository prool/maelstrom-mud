...
void advance_level( CHAR_DATA * ch ) {
  ...
  sprintf( buf, "Your gain is: %d/%d hp, %d/%d m, %d/%d mv %d/%d prac.\n\r", add_hp, MAX_HIT( ch ), add_mana, MAX_MANA( ch ), add_move, MAX_MOVE( ch ), add_prac, ch->practice );
...
void gain_condition( CHAR_DATA * ch, int iCond, int value ) {
  ...
  // decrease hp by 1, 2, or 3 depending on character level
      ...
      if ( !fig ) {
        switch ( dice( 1, 6 ) ) {
          ...
          case 2:
            ...
            switch ( dice( 1, 4 ) ) {
              case 1:
                sprintf( figbuf, "%s gives you 50 gold coins.\n\r",
                         figment->name );
                break;
              case 2:
                sprintf( figbuf, "%s gives you 500 gold coins.\n\r",
                         figment->name );
                break;
              case 3:
                sprintf( figbuf, "%s gives you 5 gold coins.\n\r",
                         figment->name );
                break;
              case 4:
                sprintf( figbuf, "%s gives you 1000 gold coins.\n\r",
                         figment->name );
                break;
            }

            send_to_char( AT_YELLOW, figbuf, ch );
            break;
          case 3:
          ...
          case 5:
            ...
            switch ( dice( 1, 3 ) ) {
              case 1:
                sprintf( figbuf, "%s &Gmisses &Wyou! (0)\n\r",
                         figment->name );
                break;
              case 2:
                sprintf( figbuf, "%s's smash &Rscratches &Wyou. (2)\n\r",
                         figment->name );
                break;
              case 3:
                sprintf( figbuf, "&W%s's backstab does &RUNSPEAKABLE &Wthings to you. (367891)\n\r",
                         figment->name );
                break;
          ...
          case 6:
            ...
            switch ( dice( 1, 4 ) ) {
              case 1:
                sprintf( figbuf, "%s smiles at you.\n\r",
                         figment->name );
                break;
              case 2:
                sprintf( figbuf, "%s hugs you.\n\r",
                         figment->name );
                break;
              case 3:
                sprintf( figbuf, "%s kisses you.\n\r",
                         figment->name );
                break;
              case 4:
                sprintf( figbuf, "%s farts in your direction. You gasp for air.\n\r",
                         figment->name );
                break;
            }
        ...
        switch ( dice( 1, 6 ) ) {
          case 1:
            ...
            send_to_char( AT_LBLUE, figbuf, ch );
            break;
          case 2:
          ...
          case 5:
            ...
            switch ( dice( 1, 2 ) ) {
              case 1:
                sprintf( figbuf, "%s &Gmisses &Wyou! (0)&X\n\r",
                         figmentmob->short_descr );
                break;
              case 2:
                sprintf( figbuf, "%s's smash &Rscratches &Wyou. (3)\n\r",
                         figmentmob->short_descr );
                break;
            }
