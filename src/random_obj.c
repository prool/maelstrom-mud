...
//  skill,              mlow, mhigh, suffix
  { "saving-rod",       -50,  50,    "of magical rod defense"           },
  { "saving-petri",     -50,  50,    "of magical petrification defense" },
  { "saving-breath",    -50,  50,    "of magical breath defense"        },
  { "saving-spell",     -50,  50,    "of magical spell defense"         },
  { "invis",            -1,   100,   "of invisibility"                  },
  { "detect-invis",     -1,   100,   "of detect invisibility"           },
  { "hide",             -1,   100,   "of hiding"                        },
  { "sneak",            -1,   100,   "of sneaking"                      },
  { "scry",             -1,   100,   "of scrying"                       },
  { "detect-hide",      -1,   100,   "of detect hidden"                 },
  { "detect-magic",     -1,   100,   "of magic detection"               },
  { "detect-evil",      -1,   100,   "of detect evil"                   },
  { "protect",          -1,   100,   "of protection"                    },
  { "fly",              -1,   100,   "of flight"                        },
  { "infrared",         -1,   100,   "of infravision"                   },
  { "sanctuary",        -1,   100,   "of sanctuary"                     },
  { "pass-door",        -1,   100,   "of pass door"                     },
  { "haste",            -1,   100,   "of haste"                         },
  { "bless",            -1,   100,   "of bless"                         },
  { "faerie-fire",      -1,   100,   "of faerie fire"                   },
  { "giant-str",        -1,   100,   "of giant strength"                },
  ...
  { "sex",              -1,   1,     "of sex change"                    },
  { "age",              -10,  100,   "of aging"                         },
  { "height",           -3,   10,    "of size"                          },
  { "weight",           -1,   100,   "of encumbrance"                   },
  { "mana",             -200, 200,   "of magical energy"                },
  { "anti-disarm",      -100, 100,   "of grip"                          },
  { "hp",               -200, 200,   "of life"                          },
  { "move",             -200, 200,   "of endurance"                     },
  { "ac",               -200, 200,   "of armoring"                      },
  { "hitroll",          -200, 200,   "of accuracy"                      },
  { "damroll",          -200, 200,   "of the brute"                     },
  { "saving-para",      -20,  20,    "of magical paralysis defense"     },
  { "heighten-senses",  -1,   100,   "of heighten senses"               },
  { "combat-mind",      -1,   100,   "of combat"                        },
  { "bio-acceleration", -1,   100,   "of psionic defense"               }
};
