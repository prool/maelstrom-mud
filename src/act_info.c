...
bool can_use_cmd( int cmd, CHAR_DATA * ch, int level );
        ...
        if ( IS_SET( pClan->settings, CLAN_PKILL ) ) {
          switch ( wch->clev ) {
            ...
            case 0:
              ...
              break;
            case 1:
              sprintf( buf, "&R-<&WCenturion of %s&R>-", pClan->name );
              break;
            case 2:
              sprintf( buf, "&R-<&WCouncil of %s&R>-", pClan->name );
              break;
            case 3:
              sprintf( buf, "&R-<&WLeader of %s&R>-", pClan->name );
              break;
            case 4:
              sprintf( buf, "&R-<&WChampion of %s&R>-", pClan->name );
              break;
            case 5:
              sprintf( buf, "&R-<&WDeity of %s&R>-", pClan->name );
              break;
          }
        } else {
          switch ( wch->clev ) {
            default:
              sprintf( buf, "&C(&W%s&C)", pClan->name );
              break;
            case 0:
              sprintf( buf, "&C(&W%s&C)", pClan->name );
              break;
            case 1:
              sprintf( buf, "&C(&WCenturion of %s&C)", pClan->name );
              break;
            case 2:
              sprintf( buf, "&C(&WCouncil of %s&C)", pClan->name );
              break;
            case 3:
              sprintf( buf, "&C(&WLeader of %s&C)", pClan->name );
              break;
            case 4:
              sprintf( buf, "&C(&WChampion of %s&C)", pClan->name );
              break;
            case 5:
              sprintf( buf, "&C(&WDeity of %s&C)", pClan->name );
              break;
          }
        }
